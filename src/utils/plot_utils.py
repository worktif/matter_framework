...
def plot_charts(res: Dict[str, Any], out_dir_rel: str = "../experimental_data/plots"):
    ...
    output_extended_folder_dat = os.path.join(output_folder_dat, 'extended')
    ...
    plt.grid(True, which='both', ls='--', alpha=0.6)
    plt.tight_layout()
    output_file = os.path.join(output_extended_folder_dat, f'Hubble_rate.png')
    plt.savefig(output_file)
    plt.clf()
    plt.close()
    ...
    plt.grid(True, which='both', ls='--', alpha=0.6)
    plt.tight_layout()
    output_file = os.path.join(output_extended_folder_dat, f'Entanglement_Equation_of_State.png')
    plt.savefig(output_file)
    plt.clf()
    plt.close()
    ...
    plt.grid(True, which='both', ls='--', alpha=0.6)
    plt.tight_layout()
    output_file = os.path.join(output_extended_folder_dat, f'Entanglement_Energy_Density.png')
    plt.savefig(output_file)
    plt.clf()
    plt.close()
    ...
    plt.grid(True, which='both', ls='--', alpha=0.6)
    plt.tight_layout()
    output_file = os.path.join(output_extended_folder_dat, f'Hubble_Slow_Roll_Parameter.png')
    plt.savefig(output_file)
    plt.clf()
    plt.close()
    ...
    plt.grid(True, which='both', ls='--', alpha=0.6)
    plt.tight_layout()
    output_file = os.path.join(output_extended_folder_dat, f'Conformal_Time.png')
    plt.savefig(output_file)
    plt.clf()
    plt.close()
    ...
    plt.grid(True, which='both', ls='--', alpha=0.6)
    plt.tight_layout()
    output_file = os.path.join(output_extended_folder_dat, f'Post_Act_Occupation_Number_Entanglement-Enhanced Occupation.png')
    plt.savefig(output_file)
    plt.clf()
    plt.close()
    ...
    plt.grid(True, which='both', ls='--', alpha=0.6)
    plt.tight_layout()
    output_file = os.path.join(output_extended_folder_dat, f'Tensor_to_Scalar_Ratio.png')
    plt.savefig(output_file)
    plt.clf()
    plt.close()
    ...
    plt.grid(True, which='both', ls='--', alpha=0.6)
    plt.tight_layout()
    output_file = os.path.join(output_extended_folder_dat, f'Scalar_tilt_finite_difference.png')
    plt.savefig(output_file)
    plt.clf()
    plt.close()
